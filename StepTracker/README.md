...
[![Nuget](https://img.shields.io/nuget/v/SoftwareAteliers.StepTracker.svg?style=flat&color=2196f3)](https://www.nuget.org/packages/SoftwareAteliers.StepTracker/)
...
* Install the template from NuGet repository: `dotnet new -i SoftwareAteliers.StepTracker`
